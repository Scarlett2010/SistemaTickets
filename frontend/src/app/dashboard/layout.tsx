  ...
  return (
    <>
        ...
        <div className="px-3 py-3 lg:px-5 lg:pl-3 ">
          <div className="flex items-center justify-between">
            <div className="flex items-center justify-start ">
              <Sheet>
                ...
                <SheetContent side={"left"}>
                  <SheetHeader className="p-4 mb-5">
                    {/* avatar */}
                    <SheetTitle className="flex flex-col m-3 items-center justify-center">
                      {
                        <div>
                          <Avatar>
                            <AvatarImage
                  ...
                  <SheetFooter className="!flex-col ">
                    {links.map((link) => (
                      <SheetClose
                        key={link.href}
                        asChild
                        className="w-full text-base capitalize text-gray-900 font-normal rounded-lg flex  p-2 mt-3 hover:bg-gray-100"
                      >
            ...
            <div className="flex items-center">
              <div className="hidden sm:flex flex-shrink-0  transition-width duration-75">
                <ul className="flex justify-center items-center">
                  {links.map((link) => (
                    <li key={link.href}>
                      <Link
                        href={link.href}
                        className=" text-base capitalize text-gray-900 font-normal rounded-lg flex  p-2 hover:bg-gray-100"
                      >
      ...
      <div className="overflow-hidden bg-white pt-16">
        <main className="w-full sm:w-[95%] lg:w-[90%] mx-auto">
          <div className="pt-6">
        ...
        <footer className="bg-slate-200 md:flex md:items-center md:justify-evenly shadow p-4 md:p-6 xl:p-8 mt-5">
          <div className="flex items-center  md:flex-col sm:justify-center  mb-4 md:mb-0">
          ...
          <div>
            <ul className="flex items-center sm:justify-center flex-wrap mb-6 md:mb-0">
              <li>
                <a
                  href="#"
